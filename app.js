(function () {
  ...
  const STRINGS = {
    es: {
      ...
      meta_time: "Tiempo",
      case1_title:
        "Relleno tercio medio e inferior: feminización de mandíbula y mentón + bioestimuladores",
      case1_zone: "Tercio medio e inferior, mandíbula y mentón",
      case1_tech: "Fillers (ácido hialurónico) y bioestimuladores",
      case1_time: "Resultado inmediato del volumen; evolución por bioestimulación según plan",
      case2_title: "Relleno labial y bioestimulador",
      case2_zone: "Labios",
      case2_tech: "Ácido hialurónico y bioestimulador",
      case2_time: "Cambios inmediatos en relleno y bioestimulación",
      ...
      case7_title: "Fillers labiales — resultado inmediato",
      case7_zone: "Labios",
      case7_tech: "Ácido hialurónico (fillers labiales)",
      case7_time: "Resultado inmediato",
      ...
      case8_title: "Pérdida de peso con GLP1 + GIP",
      case8_tech: "Inyección subcutánea de GLP1 + GIP",
      case8_time: "6 meses",
    ...
    en: {
      ...
      meta_time: "Timing",
      case1_title:
        "Mid/lower face fillers: jaw & chin feminization + biostimulators",
      case1_zone: "Midface, lower third, jawline and chin",
      case1_tech: "Hyaluronic acid fillers and biostimulators",
      case1_time: "Immediate volume; biostimulation evolves per medical plan",
      case2_title: "Lip fillers and biostimulator",
      case2_zone: "Lips",
      case2_tech: "Hyaluronic acid and biostimulator",
      case2_time: "Immediate visible changes for both techniques",
      ...
      case7_title: "Lip fillers — immediate result",
      case7_zone: "Lips",
      case7_tech: "Hyaluronic acid (lip fillers)",
      case7_time: "Immediate result",
      ...
      case8_title: "Weight loss with GLP1 + GIP",
      case8_tech: "Subcutaneous GLP1 + GIP injection",
      case8_time: "6 months",
